...
const labels:Record<keyof Facts,string>={title:'Titre de l’événement',dateLabel:'Date affichée',start:'Date et heure de début',end:'Date et heure de fin',room:'Salle',rsvp:'Lien d’inscription',groupPage:'Page du groupe',audience:'Public',technicalName:'Terme technique',message:'Message'};
